...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (calendarElement && devotionalContent && shareButton) {
        ...
        async function fetchDevotional(date) {
            ...
            bibleButton.classList.add('hidden', 'scale-90', 'opacity-0');
            ...
            try {
                ...
                if (response.ok) {
                        ...
                        <div class="space-y-12 animate-fade-in-up" style="animation-delay: 100ms">
                            <article>
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 id="ref-old" class="text-xl font-bold text-slate-800 dark:text-slate-100">${data.reference_old_testament}</h3>
                                </div>
                            ...
                            <article>
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 id="ref-new" class="text-xl font-bold text-slate-800 dark:text-slate-100">${data.reference_new_testament}</h3>
                                </div>
                                <div class="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
                    ...
                    bibleButton.classList.remove('hidden');
                    bibleButton.classList.add('flex');
                    setTimeout(() => {
                        shareButton.classList.remove('scale-90', 'opacity-0');
                        shareButton.classList.add('scale-100', 'opacity-100');
                        bibleButton.classList.remove('scale-90', 'opacity-0');
                        bibleButton.classList.add('scale-100', 'opacity-100');
                    }, 50);
                } else {
                    devotionalContent.innerHTML = `
